...
func TestStringFromErr(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want:    "serr message => function->rohanthewiz/serr.TestStringFromErr; location->serr/utils_test.go:58",
			wantAlt: "serr message => location->serr/utils_test.go:58; function->rohanthewiz/serr.TestStringFromErr",
		},
	}
